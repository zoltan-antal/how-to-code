...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |space-invaders-clone v2|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
        ...
        [else
         (if (collision? (first (game-missiles g)) (game-invaders g))
             (resolve-collisions (make-game (remove-invader (first (game-missiles g)) (game-invaders g))
                                            ...
                                            (game-tank g)))
             (local [(define no-collisions (resolve-collisions (make-game (game-invaders g)
                                                                          (rest (game-missiles g))
                                                                          (game-tank g))))]
               
               (make-game (game-invaders no-collisions)
                          (cons (first (game-missiles g))
                                (game-missiles no-collisions))
                          (game-tank g))))]))
